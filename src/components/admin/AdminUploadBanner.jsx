...
import uploadImg from "../../assets/adminUploadImg.svg";
  ...
  const handleUpload = async () => {
    ...
    if (formData && userVerified && email) {
      try {
        ...
        navigate("/dashboard/manage-banners"); // Redirect to the home page
      } catch (error) {
          ...
          <div className="text-white bg-[#000] border !border-[#FFDE00] py-[44px] p-4 rounded-lg m-2">
            ...
            <form onSubmit={handleEmailSubmit}>
              <div className="flex flex-col gap-2 w-full">
                <label htmlFor="email" className="text-[#333232c1]">
      ...
      <div className="flex flex-col gap-2">
        <div className="mt-4 md:!w-[70vw] xsm:w-full">
          ...
          <input
            ...
            className="w-full p-2 rounded-lg bg-transparent border text-black "
          />
        </div>
        <div className="mt-4 md:!w-[70vw] xsm:w-full">
          <label htmlFor="link" className="block mb-2 text-black">
...
export default AdminUploadBanner;
